...
function LogIn(){
    return(
        <div className="header-right-started">
              <span>
                {/* <button > */}
                  <Link  to={'/signup'} className='btn btn-dark' >Getting Started</Link>
                {/* </button> */}
              </span>
            </div>
    // <ul className="navbar-nav">
    //     <li className="nav-item">
    //         <Link className='nav-link btn btn-primary' to={'/signup'} >Getting Started</Link>
    //     </li>
    //     {/* <li className="nav-item">
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <div className="header-left">
          <Link to={"/"}>
            <svg height={27} viewBox="0 0 3944 610" className="bn bo">
                ...
                <div className=''>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        <li className="nav-item active">
                            ...
                            <li className="nav-item active">
                                <Link className='nav-link' to={'/creator'} >Write</Link>
                            </li>
                            {/* <li className="nav-item">
